...
<body class="seminar-kit-page home-page">
  @php
    ...
    $packages = [
      ['group' => 'Paket Ekonomis', 'label' => 'Grup A', 'name' => 'Ekonomis 1', 'tag' => 'Tas Spunbond Oval', 'text' => 'Tas Spunbond Oval · Notes A6 · Pulpen Custom'],
      ['group' => 'Paket Ekonomis', 'label' => 'Grup A', 'name' => 'Ekonomis 2', 'tag' => 'Tas Spunbond Oval Besar', 'text' => 'Tas Spunbond ukuran besar · Notes A5 · Pulpen Custom · Pin Custom'],
      ['group' => 'Paket Ekonomis', 'label' => 'Grup A', 'name' => 'Ekonomis 3', 'tag' => 'Tas Spunbond Oval', 'text' => 'Tas Spunbond · Notes A6 tebal · Pulpen · Mug logo · Pin Custom'],
      ['group' => 'Paket Ekonomis', 'label' => 'Grup A', 'name' => 'Ekonomis 4', 'tag' => 'Tas Spunbond Kotak', 'text' => 'Tas Spunbond · Notes A5 · Pulpen · Name Tag · Mug · Pin'],
      ['group' => 'Paket Reguler', 'label' => 'Grup B', 'name' => 'Reguler 1', 'tag' => 'Totebag Blacu', 'text' => 'Totebag Blacu · Notes A5 · Pulpen · Name Tag · Mug · Gantungan Pin'],
      ['group' => 'Paket Reguler', 'label' => 'Grup B', 'name' => 'Reguler 2', 'tag' => 'Totebag Blacu', 'text' => 'Totebag · Notes A6 tebal · Pulpen · Name Tag · Mug · Flashdisk'],
      ['group' => 'Paket Reguler', 'label' => 'Grup B', 'name' => 'Reguler 3', 'tag' => 'Totebag Canvas', 'text' => 'Totebag Canvas · Agenda Kulit A5 · Pulpen · Tumbler · Gantungan Pin'],
      ['group' => 'Paket Reguler', 'label' => 'Grup B', 'name' => 'Reguler 4', 'tag' => 'Totebag Canvas', 'text' => 'Totebag · Agenda · Tumbler · Flashdisk · Kotak Metal Custom'],
    ];
          ...
          <div class="sk-package-grid">
            @foreach($items as $index => $package)
              <article class="sk-package-card">
                <img src="{{ asset($seminarImages[($loop->parent->index * 4 + $index) % count($seminarImages)]) }}" alt="Paket seminar kit {{ $package['name'] }}" loading="lazy">
