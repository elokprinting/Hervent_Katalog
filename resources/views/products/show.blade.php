...
<head>
    ...
    <main>
        <div class="pd-layout">
            ...
            <div class="pd-info">
                ...
                <div class="pd-action">
                    @php
                        $waText = urlencode('[P] Halo HERVENT, saya tertarik dengan produk ' . $product->name . '. Mohon informasi harga dan minimum ordernya.');
                    @endphp
    ...
    <!-- Floating WA -->
    <a href="https://wa.me/62811912502?text={{ rawurlencode('[P] Halo HERVENT, saya ingin konsultasi produk custom untuk kebutuhan perusahaan saya.') }}" class="pd-floating-wa" target="_blank" rel="noopener" aria-label="Konsultasi Gratis">
